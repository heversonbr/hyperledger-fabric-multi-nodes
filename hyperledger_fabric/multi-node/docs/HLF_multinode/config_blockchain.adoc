...
In order to submit a transaction to create the channel for its instantiation we have previously
<<channel-tx_create, generated a transaction>>  to create our channel.
...
Next, we have to enroll each peer by running the following.
