...
function usage {
    ...
    echo "        ./11_sign_channel-tx.sh org2       : Signs the file with org2 admin certificate/key"
}
...
if [ ! -f $CHANNEL_TX_FILE ]; then
    ...
    echo "File $CHANNEL_TX_FILE exists locally. (It seems like you are running from ORDERER!)"
fi
echo "---------------------------------------"
