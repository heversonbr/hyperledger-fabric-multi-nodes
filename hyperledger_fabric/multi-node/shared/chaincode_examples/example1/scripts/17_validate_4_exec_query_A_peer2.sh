...
function usage {
    echo "USAGE: "     
    echo "ex:   ./17_validate_4_exec_query_A_peer2.sh <ORG_NAME> <PEER_NAME> [<PEER_IP_ADDRESS>, default=192.168.1.17  [PORT_BASE_NUMBER default=7050]"
    echo "      ./17_validate_4_exec_query_A_peer2.sh   org1   peer2   192.168.1.17"
